...
class ColorClipTabLayout @JvmOverloads constructor(
    context: Context,
    ...
    private var colorClipTabLayoutOnPageChangeListener: ColorClipTabLayoutOnPageChangeListener? =
        null
    ...
    init {
        if (attrs != null) {
            ...
            tabTextColor = ta.getColor(
                R.styleable.ColorClipTabLayout_text_unselected_color,
                Color.parseColor("#000000")
            )
            tabSelectedTextColor = ta.getColor(
                R.styleable.ColorClipTabLayout_text_selected_color,
    ...
    class ColorClipTabLayoutOnPageChangeListener(tabLayout: TabLayout) :
