...
class WechatFragment : BaseMvpFragment<WechatPresenter>(), WechatContract.View {

    @BindView(R.id.tab_layout)
    internal var tab_layout: ColorClipTabLayout? = null
    @BindView(R.id.view_pager)
    internal var view_pager: ViewPager? = null
