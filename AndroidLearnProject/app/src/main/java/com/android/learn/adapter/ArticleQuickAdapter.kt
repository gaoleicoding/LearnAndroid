...
class ArticleQuickAdapter(internal var context: Context, internal var list: List<FeedArticleData>, internal var fromWhere: String) : BaseQuickAdapter<FeedArticleData, BaseViewHolder>(R.layout.item_article_list, list) {
