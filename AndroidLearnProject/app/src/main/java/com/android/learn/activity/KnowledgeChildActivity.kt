...
class KnowledgeChildActivity : BaseMvpActivity<KnowledgeChildPresenter>(), KnowledgeChildContract.View {
    @BindView(R.id.iv_back)
    internal var iv_back: ImageView? = null
    @BindView(R.id.title)
    internal var title: TextView? = null
    @BindView(R.id.tv_empty_knowledge)
    internal var tv_empty_knowledge: TextView? = null
    @BindView(R.id.article_recyclerview)
    internal var article_recyclerview: RecyclerView? = null
