...
class UserFragment : BaseMvpFragment<UserInfoPresenter>(), UserInfoContract.View {

    @BindView(R.id.iv_user_photo)
    var iv_user_photo: ImageView? = null
    @BindView(R.id.tv_user_profile_not_login)
    internal var tv_user_profile_not_login: TextView? = null
