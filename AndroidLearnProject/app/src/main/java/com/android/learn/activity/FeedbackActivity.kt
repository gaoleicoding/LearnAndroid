...
class FeedbackActivity : BaseMvpActivity<*>() {
    ...
    internal var send_btn: TextView? = null
    @BindView(R.id.add_attachment)
    internal var add_attachment: TextView? = null
    @BindView(R.id.file_dir)
    internal var file_dir: TextView? = null

    @BindView(R.id.et_email_title)
    internal var et_email_title: EditText? = null
    @BindView(R.id.et_email_content)
    internal var et_email_content: EditText? = null
