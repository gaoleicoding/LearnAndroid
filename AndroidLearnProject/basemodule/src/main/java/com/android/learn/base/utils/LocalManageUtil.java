...
public class LocalManageUtil {
    ...
    public static Locale getSystemLocale(Context context) {
        return (Locale) SPUtils.getParam(context, "system_language", Locale.ENGLISH);
    }
//
...
//        switch ((Integer) SPUtils.getParam(context, "language", 0)) {
//            case 0:
...
//        }
    ...
    public static void saveSystemCurrentLanguage(Context context) {
        ...
        SPUtils.setParam(context, "system_language", locale);
    }
